-- =====================================================================
-- Sadaqah Sweden — Migration 0018
-- Bugfix: private.insamling_status_skydd() — samma bugg som 0017 fixade
-- för pengaskydd. 0013 redefinierade status_skydd med
-- pg_catalog.current_user (existerar inte). Trigger kraschade på ALLA
-- status-övergångar utom service_role.
--
-- Hittad under verifiering Steg 5–7, CP2 (skicka in till granskning).
-- Fix: byt pg_catalog.current_user → current_user.
-- =====================================================================
